...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'administrator', 'payment-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Designs', path: '/designs', entity: 'design', service: AccessServiceEnum.PROJECT, icon: FiFeather },
    { name: 'Galleries', path: '/galleries', entity: 'gallery', service: AccessServiceEnum.PROJECT, icon: FiGrid },
    { name: 'Images', path: '/images', entity: 'image', service: AccessServiceEnum.PROJECT, icon: FiImage },
    {
      name: 'Parameters',
      path: '/parameters',
      entity: 'parameter',
