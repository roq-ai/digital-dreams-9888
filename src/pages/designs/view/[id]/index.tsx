            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('design', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/designs/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Design Name" text={data?.design_name} />

                <FormListItem label="Design Path" text={data?.design_path} />
