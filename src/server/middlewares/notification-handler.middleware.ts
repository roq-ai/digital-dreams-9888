...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'image.create': {
    roles: ['team-member', 'administrator'],
    key: 'new-image-uploaded',
    tenantPath: ['organization', 'user', 'image'],
    userPath: [],
  },
  'image.delete': {
    roles: ['team-member', 'administrator'],
  ...
  'design.create': {
    roles: ['team-member', 'administrator'],
    key: 'new-design-uploaded',
    tenantPath: ['organization', 'user', 'design'],
    userPath: [],
  },
  'payment.update': { roles: ['business-owner'], key: 'payment-details-updated', tenantPath: [], userPath: [] },
  'parameter.update': {
    roles: ['team-member', 'administrator'],
    key: 'parameters-adjusted',
    tenantPath: ['organization', 'user', 'parameter'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'administrator', 'payment-manager'];
